...
void solve(){
    ...
    while(q--) {
        ...
        int s12 = min(bd[0][1], bd[1][0]);
        int s13 = min(bd[0][2], bd[2][0]);
        int s23 = min(bd[2][3], bd[3][2]);

        int rem = abs(bd[1][2]-bd[2][1]); 
        cout << s12+s13+s23+ 2 * remaining << endl;
    }
}
